...
public class ActivityEventController {
	...
	public ResponseEntity<Activity> postActivityEvent(@RequestBody Activity activityEvent)
	...
	//Comunicación
		...
		public ResponseEntity<?> obtenerAlumnosPorCursos(@RequestParam List<Integer> ids){
